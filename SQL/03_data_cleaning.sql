...
-- Step 03.1: Create a cleaned copy of the raw dataset
...
-- Step 03.2: Preview clean_uber_bookings tab
SELECT *
FROM clean_uber_bookings;



-- Step 03.3: Standardize binary ride indicators
...
-- Step 03.4: Rename columns for one-row-per-ride granularity
